...
<?php 
    ...
    // Get this total Product count
        $total_count = $product->count_product_by_type($type = 'grind_gear'); 

    // CALL THE PGINATION CLASS BECAUSE SO AS TO PAGINATE THE LIST OF PRODUCT  .
        $pagination = new Pagination($current_page,  $per_page,  $total_count);

    //  Call the GET METHODS
        $select_product = $product->get_product_by_type($type = 'grind_gear', $pagination); 
...
<html>
<head>
   <title>Grind Gear Store - The Academic Mentor</title>    
...
<body>
    <div id="full-page" class="container-fluid" style="background-color:white;">
        ...
        <div class="center content-title">
            <h2>Grind Gears</h2>
            <h3 class="flow-text">Get the latest book from TAM's Collection</h3>
        </div>      
