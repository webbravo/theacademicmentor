     <?php $page_title = "List of award";?>
     <?php include_once("includes/head.php");?> 
     <?php 
        
         global $award , $database;
        ...
        // TABLE NAME 
           $tbl = $award->table_name; 
                
        // Get this total award count
            $total_count = $award->count_award(); 

        // CALL THE PGINATION CLASS BECAUSE SO AS TO PAGINATE THE LIST OF Award  .
            $pagination = new Pagination($current_page,  $per_page,  $total_count);

        //  Call the GET METHODS
            $select_award = $award->get_all($pagination); 
                            ...
                            <div class="col-sm-12">
                                <div class="page-title">
                                    <div class="row">
                                        ...
                                        <h3 class="pull-left">See all Award</h3>
                                ...
                                <form  method="post" enctype="multipart/form-data" id="form-product" class="">
                                    <div style="overflow-x:auto;">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <td class="text-center">Award photos</td>
                                                    <td class="text-left">                 
                                                       <a href="#" class="asc">Award title</a>
                                                    </td>
                                            ...
                                            <tbody>
                                             <?php 
                                                    ...
                                                    while ($rows = $database->fetch_array($select_award)) {
                                                        # code...
                                              ...
                                              ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                       <a data-original-title="<?php echo $rows['awardTitle']; ?>" data-toggle="modal" data-target="#awardModal<?php echo $rows["id"]; ?>"> 
                                                         <img style="max-width:70px;" src="../<?php echo $rows['awardPhoto']; ?>" alt=" 30&quot;" class="img-thumbnail img-responsive">
                                                      </a>  
                                                    </td>
                                                    <td class="text-left"><?php echo $rows['awardTitle']; ?></td>
                                                    
                                                    <td class="text-center">
                                                       <a  title="" class="btn btn-primary" data-original-title="View" data-toggle="modal" data-target="#myModal<?php echo $rows["id"]; ?>">
                                                          <i class="fa fa-eye"></i>
                                                       </a>
                                                       <a href="edit.award.php?id=<?php echo $rows['id']; ?>" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Edit">
                                                ...
                                                <?php  include("includes/award.modal.php");?>
                                               <?php } ?>  
                                                ...
                                                <?php 
                                                   if($pagination->total_pages() > 1){
                                                       ...
                                                       if($pagination->has_previous_page()){
                                                           echo "<li class='prev'><a href='award.php?page=".$pagination->previous_page()."'>← Previous </a></li>";
                                                       }
                                                       ...
                                                       for ($i=1; $i <= $pagination->total_pages() ; $i++) { 
                                                           ...
                                                           if($i == $current_page){
                                                                ...
                                                                echo "<li><a href='award.php?page=".$i." '>".$i."</a></li>";
                                                           }
                                                       ...
                                                       if($pagination->has_next_page()){
                                                           echo "<li class='next'><a href='award.php?page=".$pagination->next_page()."'>Next → </a></li>";
                                                       }
