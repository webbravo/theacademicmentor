                ...
                <div class="page-content-wrapper">
                    <div class="content-wrapper container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="well">
                                    <h3 class="">New booking Request</h3><br>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php while ($rows = $select_booking->fetch()) :  ?>
                                                    <tr>
                                                        ...
                                                        <a title="Approved booking" href="approve_booking.php?id=<?php echo $rows['id'];?>&action=<?php echo 'approved'; ?>"  class="btn btn-success" data-original-title="Edit">
