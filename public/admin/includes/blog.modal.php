...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header text-center">
            <h4 class="modal-title"><?php echo $rows["blogTitle"]; ?></h4>
        </div>
        <div class="modal-body">

                <img class="img-responsive" src="../<?php echo $rows["blogPhoto"]; ?>" alt=""> 
                <p><?php echo htmlspecialchars_decode( $rows["blogStory"]); ?></p> 
