<?php $page_title = "Customer list";?>
     ...
     <?php 
        ...
        // TABLE NAME 
            $tbl = $customers->table_name; 
                
        // Get this total customers count
            $total_count = $customers->count_customers(); 

        // CALL THE PGINATION CLASS BECAUSE SO AS TO PAGINATE THE LIST OF customers  .
            $pagination = new Pagination($current_page,  $per_page,  $total_count);

        //  Call the GET METHODS
            $select_customers = $customers->getCustomers($pagination); 
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php while ($rows = $select_customers->fetch()) :  ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><?php echo $rows['address']; ?></td>
                                                        ...
                                                        <a title="Delete Customer" href="delete.php?tbl=<?php echo $tbl;?>&fid=<?php echo (int)$rows['id']; ?>"  class="btn btn-danger" data-original-title="View">
