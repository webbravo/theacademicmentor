    ...
    <?php  
      ...
      // Import Class files
        ...
        $awardInfo = $award->get_award_by_id($id);

        // Check the Award detail Into an array
           $awardTitle  = $awardInfo["awardTitle"];
           $awardStory  = $awardInfo["awardStory"];
           $awardPhoto  = $awardInfo["awardPhoto"];
    ?>


    <?php 
        if(isset($_POST['update_award']) == true){

            $awardTitle2       =  $_POST['awardTitle'];
            $awardPhoto2       =  $_FILES['awardPhoto'];
            $awardStory2       =  $_POST['awardStory'];
            
    

            // PERFORM DATA VALIDATION  
                $validate = $award->validate($awardTitle2 ,  $awardStory2 );
                ...
                switch ($validate) {
                    ...
                    default:
                        ...
                        $update_award = $award->update($id, $awardTitle2, $awardPhoto2, $awardStory2 );
                        break;
                }
                                        ...
                                        <form method="POST" action="<?php $_SERVER["PHP_SELF"];?>" enctype="multipart/form-data" class="form-horizontal group-border stripped">
                                           ...
                                           <!-- Award Name -->  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="file" name="awardPhoto" class="form-control">
                                                    <br>
                                                </div> 
                                                <div class="col-sm-2">
                                                    <img  class="img-responsive" src="../<?php echo $awardPhoto?>"  alt="Award photo">
                                                </div> 
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div style="margin-left:30px;" class=" col-sm-6">
                                                    <button class="btn btn-success btn-md" type="submit" name="update_award">
                                                        Add Award
                                                    </button>
                                                </div>
                                            </div>
