                            ...
                            <div class="col-sm-12">
                                <div class="page-title">
                                    <div class="row">
                                        ...
                                        <h3 class="pull-left">See all Product</h3>
                                ...
                                <form  method="post" enctype="multipart/form-data" id="form-product" class="">
                                    <div style="overflow-x:auto;">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <td class="text-center"><h4>Product Photo</h4></td>
                                            ...
                                            <tbody>
                                             <?php while ($rows = $select_product->fetch()) :  ?>
                                                <tr>
                                                    <td class="text-center">
                                                       <a style="cursor:pointer" data-original-title="<?php echo $rows['name']; ?>" data-toggle="modal" data-target="#myModal<?php echo $rows["id"]; ?>"> 
                                                         <img style="max-width:70px;" src="../<?php echo $rows['photo']; ?>" alt=" 30&quot;" class="img-thumbnail img-responsive">
                                                      </a>  
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                       ...
                                                       <a href="edit.product.php?id=<?php echo $rows['id']; ?>" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Edit">
                                                ...
                                                <?php 
                                                   if($pagination->total_pages() > 1){
                                                       ...
                                                       if($pagination->has_previous_page()){
                                                           echo "<li class='prev'><a href='products.php?page=".$pagination->previous_page()."'>← Previous </a></li>";
                                                       }
                                                       ...
                                                       if($pagination->has_next_page()){
                                                           echo "<li class='next'><a href='products.php?page=".$pagination->next_page()."'>Next → </a></li>";
                                                       }
